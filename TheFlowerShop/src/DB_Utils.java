...
// This class can be invoked without instantiation to provide a Connection object.
// It uses the singleton design pattern so that only one object exists during the lifetime of your application.
...
public final class DB_Utils {
    ...
    private static final String DATAFILENAME="flowershop.accdb"; // this is the full name of your Access database including file extension
